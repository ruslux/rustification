...
Есть несколько дополнительных способов объявить функцию, но они включают в себя особенности о которых мы пока не знаем, так что давайте оставим так как есть.
