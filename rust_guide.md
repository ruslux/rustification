...
Этот файл используется Cargo отслеживания зависимостей в вашем приложении. Прямо сейчас у нас нет ни одной, поэтому этот файл довольно пуст. Вы никогда не должны править этот файл самостоятельно, позвольте Cargo самому поработать над ним.
